...
{
public:
    elemType* search(const elemType& searchItem) const;
      //Function to determine if searchItem is in the binary
      //search tree.
      //Postcondition: Returns a pointer to the entry which matches //changed description
      //	       searchItem if searchItem is found in
...
private:
    void deleteFromTree(nodeTypeT<elemType>* &p);
...
template <class elemType>
elemType* bSearchTreeType<elemType>::search
                 ...
                 (const elemType& insertItem)
{
    ...
    nodeTypeT<elemType> *trailCurrent = nullptr; //pointer 
                                              //behind current
    nodeTypeT<elemType> *newNode;  //pointer to create the node

    newNode = new nodeTypeT<elemType>;
...
{
    nodeTypeT<elemType> *current; //pointer to traverse the tree
    nodeTypeT<elemType> *trailCurrent; //pointer behind current
    bool found = false;
...
void bSearchTreeType<elemType>::deleteFromTree
                                 (nodeTypeT<elemType>* &p)
{
    nodeTypeT<elemType> *current; //pointer to traverse the tree
    nodeTypeT<elemType> *trailCurrent;  //pointer behind current
    nodeTypeT<elemType> *temp;      //pointer to delete the node
